  ...
  if(props.id) {
   ...
   return (
     <div className={a.wrapper}>
          <AuthorizeFormRedux  isAuth={isAuth} message = {props.message} onSubmit={pushFormData} />
     </div>
   )
}
   ...
   return  (
    ...
    <form className={a.login} onSubmit = {props.handleSubmit}>
      ...
      <div className={a.password__container}>
        ...
        <button type="submit" value="Войти">Sign in </button>
      </div>
      <div className={a.extra}>
          <NavLink to='/login'>  <a href="#" className={a.register}>Log in</a> </NavLink>
      </div>
...
const AuthorizeFormRedux = reduxForm({
  form:'authorize'
})(AuthorizeForm);
